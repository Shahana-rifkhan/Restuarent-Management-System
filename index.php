...
<body>
    ...
    <div class="home" id="home">
        ...
        <div class="section-padding" id="foodmenu"> <!-- Food Styles -->
            <div class="food-items">
                <div class="item">
                    ...
                    <h3>Indian Style</h3>
                    <p>Indian foodstyle is a tantalizing journey of aromatic spices, 
                        diverse regional flavors, and a harmonious blend of sweet, savory, and spicy elements, 
                        creating a rich tapestry of culinary traditions that have delighted palates for centuries.</p>
                ...
                <div class="item">
                    ...
                    <p>Sri Lankan foodstyle is a vibrant tapestry of flavors, blending aromatic spices, coconut, 
                        and tropical ingredients to create a rich and diverse culinary heritage known for its balance of sweet, 
                        spicy, and savory elements.</p>
                ...
                <div class="item">
                    ...
                    <p>"Beverages range from soothing teas to refreshing cocktails. Desserts offer sweet delights, 
                        from creamy cheesecakes to indulgent chocolate truffles."</p>
                ...
                <div class="item">
                    ...
                    <h3>Fast Food</h3>
                    <p>Fast food is a convenient and quick dining option that typically includes items like burgers, 
                        fries, and sandwiches, designed for on-the-go consumption, offering simplicity, 
                        speed, and familiar, comforting flavors.</p>
                ...
                <div class="item">
                    ...
                    <h3>Offers !!</h3>
                    <p>Experience delectable cuisine and savings at our restaurant. Enjoy tantalizing dishes with special offers. 
                        Indulge in flavors while saving big. <br><br>Don't miss out on our mouthwatering deals.</p>
            ...
            <div class="question">
                ...
                <div>
                    <div class="q-ans">
                        ...
                        <div>
                            <h4>Blue Mojito</h4>
                            <p>Savor the refreshing burst of zesty lime and the invigorating, 
                                minty coolness in every sip of our tantalizing blue mojito.</p>
                        </div>
                    </div>
                    ...
                    <div class="q-ans">
                        ...
                        <div>
                            ...
                            <p>Indulge in the mouthwatering heat of succulent, 
                                spiced chicken enveloped in fragrant, aromatic rice, 
                                all coming together in a delightful spicy chicken biriyani 
                                that's sure to tantalize your taste buds.</p>
                        </div>
                    </div>
                    ...
                    <div class="q-ans">
                        ...
                        <div>
                            ...
                            <p>Indulge in the delectable fusion of succulent, 
                                spicy chicken, gooey melted cheese, 
                                and a symphony of savory flavors with our mouthwatering cheese chicken burger.</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="main_slide3"> <!-- Our Popular food items -->
            <div class="fav-head">
                ...
                <p>
                    From the rich, creamy goodness of our Signature Cuisine chicken biriyani, salads, kottu and 
                    noodles to the sizzling perfection of our steak, each dish is a symphony of flavors that delights the palate. <br><br>
            ...
            <div class="fav-food">
                <div class="item">
                    ...
                    <h3>Kottu</h3>
                    <p>Savor the irresistible heat and aromatic spices that dance through every bite of our delectable spicy kottu, 
                        a culinary adventure that ignites the senses.</p>
                ...
                <div class="item">
                    ...
                    <h3>Salads</h3>
                    <p>Our salads are a delightful medley of crisp, garden-fresh greens, vibrant vegetables, and tantalizing dressings, 
                        creating a healthy and flavorsome feast for your senses.</p>
            ...
            <div class="main_slide2">
                ...
                <div class="question">
                    ...
                    <div>
                        <div>
                            <p>
                                Signature Cuisine is a culinary haven where passion meets palate. 
        ...
        <div class="main_slide4"> <!-- Chef-feed -->
            <div class="chef-feed">
                ...
                <p>"I recently dined at your restaurant, and I must say, it was an exceptional experience from start to finish. The ambiance was charming, 
                    the staff incredibly attentive, and the food, simply divine. The flavors in every dish were a revelation, 
                    and I couldn't help but appreciate the dedication to quality ingredients and culinary artistry. Your team made me feel truly valued as a customer, 
                    and I can't wait to return for another unforgettable meal. You've set the bar high for hospitality and gastronomy, and I'm thrilled to be a loyal patron. 
                    Thank you!"</p>
    ...
    <div class="footer"> <!-- Footer -->
        <div class="footer-1">
            ...
            <div>
                <address>
                    ...
                    <p>Phone: 0114 777 888</p>
                    <p>Mr. Stelon Daniel <br>No. 36 De Kretser Pl, Colombo 00400</p>
                </address>
            </div>
        </div>
        ...
        <div class="footer-2">
            <img src="./Home image/123.png" alt="">
            <h2>Powered by <em>Signature Cuisine 2024</em></h2>
        </div>
    </div>
